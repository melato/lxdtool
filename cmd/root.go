...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.lxdtool.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".lxdtool" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".lxdtool")
	}
